...
<section class="catalog">
	<div class="container container_items container_big">
		<div class="js-brands_2-slider swiper">
								...
								<div class="swiper-slide" >
									<div class="item">
										<div class="img_wrapper">
											<img src="<?=(!empty($arSection["PICTURE"]["SRC"])) ? $arSection["PICTURE"]["SRC"] : SITE_TEMPLATE_PATH.'/img/no_image.png'?>" alt="">
										</div>
